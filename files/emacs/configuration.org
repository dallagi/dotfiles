...
** TODO setup secrets https://www.gnu.org/software/emacs/manual/html_node/auth/Secret-Service-API.html
** TODO setup ts-fold (or treesit-fold)
** TODO setup emacs-pet
...
#+begin_src emacs-lisp
  ...
  (setq-default auto-revert-stop-on-user-input nil)
...
#+begin_src emacs-lisp
  (use-package eshell
    ...
    :hook
    ;; disable show-trailing-whitespace in eshell buffers
...
#+begin_src emacs-lisp
  (use-package eat
    ...
    :hook
    ;; disable show-trailing-whitespace in eat buffers
...
* Tramp
#+begin_src emacs-lisp
  ;; fix tramp for remote guix
  ;; see https://lists.nongnu.org/archive/html/guix-devel/2022-02/msg00114.html
...
** Whisper STT
#+begin_src emacs-lisp
  ;; TEMPORARILY DISABLED UNTIL I MANAGE TO SWITCH BACK TO EMACS 30
  ;; (use-package whisper
