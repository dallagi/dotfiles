...
#+begin_src emacs-lisp
  ...
  (interactive)
  ;; TODO
  ;; for inspiration: https://github.com/bbatsov/projectile/pull/1474/files#diff-a448a7e36d92f29a14e851a15a0ea0c384ccd9721d6474dc45e7bf4999090859R3413
  )
  ...
  (use-package vterm
    ...
    (my-leader-def
      ...
      "ot" '(my/project-vterm :which-key "Shell at project path")
      "oT" '(vterm :which-key "Vterm at current path")))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package helpful
    ...
    :general
    (:keymaps 'emacs-lisp-mode-map "K" 'helpful-at-point)
