...
#+begin_src emacs-lisp
  ...
  (use-package consult
    ...
    (consult-ripgrep-args "rg --null --hidden --line-buffered --color=never --max-columns=1000 --path-separator / --smart-case --no-heading --with-filename --line-number --search-zip")
    :general
    (my-leader-def
      :states '(motion normal visual)
      :keymaps 'override
