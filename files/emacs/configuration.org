...
#+begin_src emacs-lisp
  (use-package chatgpt-shell
    :custom
    ((chatgpt-shell-model-versions '("gpt-4" "gpt-3.5-turbo"))
  ...
  (use-package prima-tools-transient
    :ensure nil
      ...
      (my-leader-def
        :states '(motion normal visual)
        :keymaps 'override
        "j" '(prima-tools-transient :which-key "Prima tools")))
#+end_src
...
#+begin_src emacs-lisp
  (use-package elixir-ts-mode
    :init
    ;; Add local installation of elixir-ls to path
  ...
  ;;   ;; disable default LSPs for elixir
  ;;   (setq lsp-disabled-clients '(elixir-ls credo-language-server))

  ;;   (add-to-list 'lsp-language-id-configuration
  ;;                '(elixir-ts-mode . "elixir"))

  ;;   (lsp-register-client
  ;;    (make-lsp-client :new-connection (lsp-stdio-connection '("next-ls" "--stdio=true"))
